...
pub fn jpeg(req: &mut Request) -> Result<Response, Error> {
...
pub fn png(req: &mut Request) -> Result<Response, Error> {
...
pub fn svg(req: &mut Request) -> Result<Response, Error> {
...
pub fn webp(req: &mut Request) -> Result<Response, Error> {
