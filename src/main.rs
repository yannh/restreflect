...
fn main(mut req: Request) -> Result<Response, Error> {
    ...
    let routes: Vec<(Method, Regex, ReqHandler)> = vec![
        ...
        (Method::GET, Regex::new(r"^/image$").unwrap(), Handler(images::image)),
        ...
        (Method::GET, Regex::new(r"/delay/(\d{1,2})$").unwrap(), Handler(dynamic_data::delay_get)),
        (Method::POST, Regex::new(r"/delay/(\d{1,2})$").unwrap(), MutHandler(dynamic_data::delay_post)),
        (Method::GET, Regex::new(r"/headers$").unwrap(), Handler(request_inspection::headers)),
        (Method::GET, Regex::new(r"/etag/(\w+)$").unwrap(), Handler(response_inspection::etag)),
        (Method::GET, Regex::new(r"/response-headers$").unwrap(), Handler(response_inspection::response_headers_get)),
        (Method::POST, Regex::new(r"/response-headers$").unwrap(), Handler(response_inspection::response_headers_post)),
